...
function getSelectItemStyle(token: SelectItemToken): number | string {
...
function genSelectionStyle(token: TokenWithCommonCls<AliasToken> & SelectItemToken, suffix?: string): CSSObject {
